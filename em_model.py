...
class EMR:
    ...
    def __init__(self):
        self.target_classes = ['enojado', 'disgustado', 'temeroso', 'contento', 'triste', 'sorprendido', 'neutral']
    ...
    def build_network(self):
        ...
        self.model = tflearn.DNN(self.network, checkpoint_path='keras_model_files/model_1_atul', max_checkpoints=1,
    ...
    def load_model(self):
        ...
        """
        if isfile("keras_model_files/model_1_atul.tflearn.meta"):
            self.model.load("keras_model_files/model_1_atul.tflearn")
